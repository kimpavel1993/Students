...
import com.meera.dbservice.model.StudentClp;
...
public class ClpSerializer {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.meera.dbservice.NoSuchStudentException")) {
            return new com.meera.dbservice.NoSuchStudentException();
        }
